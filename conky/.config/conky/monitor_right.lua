...
│  ${color1} IP: ${color2}${addr wlan0}${alignr}│
│  ${color1} Bitrate: ${color2}${wireless_bitrate wlan0}${alignr}│
│  ${color1} Up: ${color2}${upspeed wlan0} (${totalup wlan0} total)${alignr}│
│  ${color1} Down: ${color2}${downspeed wlan0} (${totaldown wlan0} total)${alignr}│
│  ${color1}${upspeedgraph wlan0 40,310 A6DA95 ED8796}${color2}  ${voffset -40}│
│                                   │
│                                   │
│  ${color1}${downspeedgraph wlan0 40,310 A6DA95 ED8796}${color2}  ${voffset -40}│
│                                   │
│                                   │
╰───────────────────────────────────╯
╭───────────────────────────────────╮
